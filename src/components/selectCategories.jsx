            ...
            <div>
                <div style={{width: '100%', height: '100%', position: 'relative', background: '#E2F1FE'}}>
                    <div style={{width: 732.50, height: 637, left: 354, top: 193, position: 'absolute'}}>
                        ...
                        <div style={{width: 238, height: 92, paddingLeft: 50, paddingRight: 50, paddingTop: 30, paddingBottom: 30, left: 494.50, top: 545, position: 'absolute', background: '#A67CF3', borderRadius: 10, justifyContent: 'center', alignItems: 'center', gap: 10, display: 'inline-flex'}}>
