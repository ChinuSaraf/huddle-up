            ...
            <div>
                <div style={{width: '100%', height: '100%', position: 'relative', background: '#E2F1FE'}}>
                    <div style={{width: 585, height: 473, left: 428, top: 275, position: 'absolute'}}>
                        ...
                        <input style={{width: 517, height: 65, left: 34, top: 210, position: 'absolute', background: 'white', boxShadow: '0px 8px 8px rgba(0, 0, 0, 0.10)', borderRadius: 10, overflow: 'hidden'}}>
                        ...
                        <button onClick={this.onClickConfirm} style={{width: 200, height: 50, paddingLeft: 50, paddingRight: 50, paddingTop: 30, paddingBottom: 30, left: 361, top: 384, position: 'absolute', background: '#A67CF3', borderRadius: 10, justifyContent: 'center', alignItems: 'center', gap: 10, display: 'inline-flex'}}>
...
export default withRouter(SelectUsername);